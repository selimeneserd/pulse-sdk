...
|11 release/migration|Local preparation complete|0.2.0 breaking construction API, same eventv1; core→adapter/optionalOTel publication order, additive Cloud-first compatibility window+rollback, pack audit/license/metadata/changelog. GitHub delivery and separate Cloud deployment were authorized and completed; npm publication remains pending.|
